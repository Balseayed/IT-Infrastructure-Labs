...
This lab focused on building a basic department-based file server using shared folders, security groups, Share permissions, and NTFS permissions.

Users were granted access only to the folders assigned to their department, and the configuration was verified by testing both successful and denied access scenarios.

This lab provides the foundation for the next File Server project, where I will implement more advanced enterprise features including:
...
These features will extend the basic file server into a more production-oriented Windows Server environment.
